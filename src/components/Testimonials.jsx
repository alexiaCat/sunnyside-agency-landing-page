        ...
        <div>
            ...
            <div className="flex flex-col md:flex-row w-screen md:px-[100px] pt-[80px] pb-[80px] md:pb-[120px] font-barlow">
                ...
                <div className="flex flex-col items-center w-full md:w-1/3 ">
                    <img class="inline-block h-[72px] w-[72px] rounded-full ring-2 ring-white" src="/assets/images/image-emily.jpg" alt="emily" />
                ...
                <div className="flex flex-col items-center w-full md:w-1/3 py-[80px] md:py-0">
                    <img className="inline-block h-[72px] w-[72px] rounded-full ring-2 ring-white" src="/assets/images/image-thomas.jpg" alt="thomas" />
                ...
                <div className="flex flex-col items-center w-full md:w-1/3">
                    <img className="inline-block h-[72px] w-[72px] rounded-full ring-2 ring-white" src="/assets/images/image-jennie.jpg" alt="jennie" />
