    ...
    return (
        <div className="flex flex-col md:flex-row w-screen h-auto md:h-[600px] font-fraunces">
            <div className="relative w-full md:w-1/2">
                <img src="/assets/images/desktop/image-graphic-design.jpg" alt="guinda" className="max-w-full md:h-auto w-full h-[600px] max-h-[600px] md:scale-x-100 scale-x-[190%]" />
            ...
            <div className="relative w-full md:w-1/2">
                <img src="/assets/images/desktop/image-photography.jpg" alt="naranja" className="max-w-full md:h-auto w-full h-[600px] max-h-[600px] md:scale-x-100 scale-x-[190%]" />
